...
export const metadata: Metadata = {
  title: "How It Works — SomStudioPhotography",
  description:
...
// What to expect at each step — expands on the process data descriptions
  ...
  return (
    <>
      ...
      <section className="bg-black border-t border-white/5">
        <Container>
          <div className="py-20 sm:py-28 space-y-0">
            {processSteps.map((step, index) => (
              <div
                key={step.step}
                className={`grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 py-12 sm:py-14 ${
              ...
              >
                ...
                <div className="lg:w-24 lg:text-right">
                  <span className="text-5xl font-bold leading-none text-zinc-800 sm:text-6xl lg:text-7xl">
                    0{step.step}
                  </span>
                </div>
        ...
        <Container>
          <div className="py-14 sm:py-16 text-center">
            <p className="mx-auto max-w-xl text-sm leading-relaxed text-zinc-500">
              ...
              and professional. Every client is handled personally — no automated
              systems, no unanswered messages.
            </p>
          </div>
        </Container>
      </section>
